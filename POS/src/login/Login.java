...
public class Login {
	...
	private JFrame fm_login;
	private JTextField tf_login_un;
	...
	private void initialize() {
		...
		JLabel lb_login_icon = new JLabel("");
		...
		JLabel lb_login_name1 = new JLabel("Madhouse");
		...
		JLabel lb_login_name2 = new JLabel("\u7570\u60F3\u6599\u7406\u5BE6\u9A57\u5BA4");
		...
		JLabel lb_login_name3 = new JLabel("POS-\u767B\u5165\u7CFB\u7D71");
		...
		JLabel lb_login_un = new JLabel("\u5E33\u865F : ");
		lb_login_un.setFont(new Font("新細明體", Font.PLAIN, 20));
		lb_login_un.setBounds(10, 90, 55, 25);
		fm_login.getContentPane().add(lb_login_un);
		
		JLabel lb_login_pw = new JLabel("\u5BC6\u78BC : ");
		...
		fm_login.getContentPane().add(tf_login_un);
		...
		JButton btn_login_login = new JButton("\u767B\u5165");
		...
		JButton btn_login_exit = new JButton("\u96E2\u958B");
